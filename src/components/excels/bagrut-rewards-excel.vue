  ...
  methods: {
    ...
    loadFile(e) {
      ...
      reader.onload = (e) => {
        ...
        workbook.Sheets[sheetName].C1.h = "studyUnits";
        workbook.Sheets[sheetName].C1.v = "studyUnits";
        workbook.Sheets[sheetName].C1.w = "studyUnits";
        workbook.Sheets[sheetName].D1.h = "questionnaire";
        workbook.Sheets[sheetName].D1.v = "questionnaire";
        workbook.Sheets[sheetName].D1.w = "questionnaire";
